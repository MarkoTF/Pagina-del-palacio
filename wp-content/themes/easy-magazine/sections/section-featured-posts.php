 ...
 */
    $featured_posts_section_title           = easy_magazine_get_option( 'featured_posts_section_title' );
    $featured_posts_content_type            = easy_magazine_get_option( 'featured_posts_content_type' );
    ...
    if( $featured_posts_content_type == 'featured_posts_page' ) :
        for( $i=1; $i<=$number_of_featured_posts_items; $i++ ) :
            $featured_posts_posts[] = easy_magazine_get_option( 'featured_posts_page_'.$i );
        endfor;  
    elseif( $featured_posts_content_type == 'featured_posts_post' ) :
        for( $i=1; $i<=$number_of_featured_posts_items; $i++ ) :
            $featured_posts_posts[] = easy_magazine_get_option( 'featured_posts_post_'.$i );
        endfor;
    endif;
    ?>
