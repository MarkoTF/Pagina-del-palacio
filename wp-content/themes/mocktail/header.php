...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#site-content-contain"><?php esc_html_e('Skip to content','mocktail'); ?></a>
	<!-- Masthead ============================================= -->
				...
				<div class="main-header clearfix">
									...
									if(1 != $cocktail_side_menu){
										if (has_nav_menu('side-nav-menu') || (has_nav_menu( 'social-link' ) && $cocktail_settings['cocktail_side_menu_social_icons'] == 0 ) || is_active_sidebar( 'cocktail_side_menu' ) ): ?>
											<button class="show-menu-toggle" type="button">		
												<span class="sn-text"><?php esc_html_e('Menu Button','mocktail'); ?></span>
								  	...
								  	if(1 != $cocktail_side_menu){ ?>
								  		<aside class="side-menu-wrap" role="complementary" aria-label="<?php esc_attr_e('Side Sidebar','mocktail');?>">
											<div class="side-menu">
												...
												if (has_nav_menu('side-nav-menu') || (has_nav_menu( 'social-link' ) && $cocktail_settings['cocktail_side_menu_social_icons'] == 0 ) || is_active_sidebar( 'cocktail_side_menu' ) ):
													...
													<nav class="side-nav-wrap" role="navigation" aria-label="<?php esc_attr_e('Sidebar Menu','mocktail'); ?>">
					...
					if($cocktail_settings['cocktail_disable_main_menu']==0){ ?>
						...
						<div id="sticky-header" class="clearfix">
							<nav id="site-navigation" class="main-navigation clearfix" role="navigation"  aria-label="<?php esc_html_e('Main Menu','mocktail');?>">
	...
	<div class="site-content-contain">
		<div id="content" class="site-content">
			...
			if( is_front_page() ) {
				...
				do_action('mocktail_display_frontpage_features');
