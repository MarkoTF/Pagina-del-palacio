 ...
 */
function core_corporate_register_required_plugins() {
    /*
    ...
    $plugins = array(      
        array(
            'name'      => esc_html__( 'Aarambha Demo Sites', 'core-corporate' ), //The plugin name
    ...
    $config = array(
        'id'           => 'core-corporate',        // Unique ID for hashing notices for multiple instances of TGMPA.
...
add_action( 'tgmpa_register', 'core_corporate_register_required_plugins' );
